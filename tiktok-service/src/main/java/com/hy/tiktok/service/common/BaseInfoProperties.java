...
public class BaseInfoProperties {
    ...
    public static final Long LONING_USER_TTL = 604800L;
    public static final Long HOT_VLOG_TTL = 604800L;
    ...
    public static final String SORT_VLOG_LIST = "sort_vlog_list";
    public static final Long HOST_LIST_MAXCOUNT = 3L;

    public static final String HOST_VLOG_LIST = "host_vlog_list";
