...
//		redis -> pipeline
	...
	* */
	...
	public void zSetAdd(String key, String name,Double score){
		redisTemplate.opsForZSet().add(key,name,score);
	}

	public void zSetRemove(String key,String name){
	...
	public Set<String> getZSetLast(String key){
		return redisTemplate.opsForZSet().range(key,getZSetSize(key)-1,getZSetSize(key)-1);
	}

	public Double getZsetScore(String key,String name){
